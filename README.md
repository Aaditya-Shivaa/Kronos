...
> The Kronos forecast runs entirely on your machine. Each asset's beginner-friendly commentary is generated by the OpenRouter AI (auto model) using your API key. If the key is missing or the API is unreachable, the script automatically falls back to built-in explanations.
